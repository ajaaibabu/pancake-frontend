...
import { useMatchBreakpoints, useModal } from '@panphoenixswap/uikit'
...
const Predictions = () => {
  ...
  const [hasAcceptedRisk, setHasAcceptedRisk] = usePersistState(false, {
    localStorageKey: 'panphoenix_predictions_accepted_risk',
  })
  const [hasAcceptedChart, setHasAcceptedChart] = usePersistState(false, {
    localStorageKey: 'panphoenix_predictions_chart',
  })
